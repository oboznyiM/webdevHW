...
class Page extends React.Component {
    ...
    addBook() {
        fetch("http://localhost:8080/add").then(res => {return 1});
    }
    ...
    onNavbarClick() {
        let isHidden = this.state.navbarhidden;
        this.setState({
